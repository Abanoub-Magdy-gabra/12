      ...
      <FooterGrid>
        ...
        <LinksSection>
          ...
          <LinksList>
            ...
            <LinkItem><NavLink href="/about">About us</NavLink></LinkItem>
            <LinkItem><NavLink href="/products">Our products</NavLink></LinkItem>
            <LinkItem><NavLink href="/contact">Contact us</NavLink></LinkItem>
          </LinksList>
        </LinksSection>
      </FooterGrid>
    </FooterContainer>
